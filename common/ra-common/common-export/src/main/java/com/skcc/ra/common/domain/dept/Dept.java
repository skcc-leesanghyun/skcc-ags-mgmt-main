...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "OCO50200", catalog = "OCO")
@Entity
public class Dept extends BaseEntity implements Apiable<DeptDto> {
    @Id
...
//    @OneToMany(fetch = FetchType.LAZY, mappedBy = "superDeptcd", cascade = CascadeType.ALL)
//    @Where(clause = "USE_YN='Y'")
////    @JoinColumn(name = "SUPER_DEPTCD")
