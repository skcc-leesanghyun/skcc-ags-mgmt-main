...
public class UserActvyLog extends BaseEntity  implements Apiable<UserActvyLogDto> {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "oco10190_seq")
    @SequenceGenerator(name = "oco10190_seq", sequenceName = "oco10190_user_actvy_seq_seq", schema = "oco", allocationSize = 1)
    @Column(name="USER_ACTVY_SEQ", nullable = false)
